...
//! level. What tells the thrusters apart is where they sit around the head: the head shadows the
//! far ear, so a jet to one side is a little quieter and duller in the other ear, and one behind
//! is duller in both.
